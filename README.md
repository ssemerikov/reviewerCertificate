...
**Version 1.1.2** | [Changelog](CHANGELOG.md) | OJS 3.3+ / 3.4+ / 3.5+
...
**Latest Release (v1.1.2)**: Critical bug fixes for OJS 3.4 backward compatibility - fixed `class_alias()` issues, global class FQN references, and missing use statements. See [CHANGELOG.md](CHANGELOG.md) for details.
