...
- **Fixed: Fatal error on OJS 3.4/3.5 — `compat_autoloader.php` not found** — Made the autoloader inclusion conditional. The file is only present in OJS 3.3 packages; OJS 3.4+ don't need it and now gracefully skip it.
